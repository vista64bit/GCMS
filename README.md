...
*10.1.2*
* อัปเดท CKEDITOR เนื่องจากได้รับรายงานว่า แอดมินเท่านั้นถึงจะอัปโหลดไฟล์ผ่าน CKEDITOR ได้
* อัปเดท Theme ทั้งหมด (ไม่สำคัญ)
* แก้ไขปัญหาอัปเดทแล้ว ไม่สามารถอ่านบทความได้
* แก้ไขปัญหา ลบหมวดหมู่แล้ว Error
* เพิ่มเมนู Debug ใช้สำหรับการ Debug ระบบ (ใช้สำหรับการออกแบบเท่านั้น จะแสดงผลเมื่อ DEBUG_MODE เท่ากับ true)